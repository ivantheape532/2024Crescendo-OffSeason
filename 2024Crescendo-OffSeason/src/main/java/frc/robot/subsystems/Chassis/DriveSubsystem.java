...
public class DriveSubsystem extends SubsystemBase {
    ...
    private void updateOdometry() {
      ...
      if(Math.abs(m_gyro.getRate()) < 720&&mt2.tagCount>0&&mt2.avgTagDist<3.2&&getChassisSpeed()<2) // if our angular velocity is greater than 720 degrees per second, ignore vision updates
      {
